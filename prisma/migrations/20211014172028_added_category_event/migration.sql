...
CREATE TABLE `products` (
    ...
    `storage_temperature_id` INTEGER NOT NULL,
    `sales_price` INTEGER,
...
-- AddForeignKey
ALTER TABLE `products` ADD CONSTRAINT `products_storage_temperature_id_fkey` FOREIGN KEY (`storage_temperature_id`) REFERENCES `storage_temperature`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `category_event` ADD CONSTRAINT `category_event_product_id_fkey` FOREIGN KEY (`product_id`) REFERENCES `products`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `category_event` ADD CONSTRAINT `category_event_event_id_fkey` FOREIGN KEY (`event_id`) REFERENCES `events`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `category_event` ADD CONSTRAINT `category_event_category_id_fkey` FOREIGN KEY (`category_id`) REFERENCES `categories`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
